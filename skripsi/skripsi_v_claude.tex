...
\input{assets/tables/idx_keandalan}
...
\input{assets/tables/idx_stabilitas}

Dua angka penting. Pertama, \textbf{32,1\%} ekspresi berbalik tanda IC antara
kedua jendela. Sinyal yang murni derau akan berbalik tanda pada sekitar 50\%
kasus; angka 32,1\% karena itu menunjukkan arah sinyal bertahan pada mayoritas
...
\input{assets/tables/idx_bench_uji}
...
\input{assets/tables/idx_backtest}
...
\textbf{Untuk penelitian lanjutan.} Pertama, pengujian ulang pada model dengan
